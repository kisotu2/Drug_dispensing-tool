    ...
    <div class="container">
        ...
        try {
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $CompanyID = $_POST['CompanyID$CompanyID'];
                $CompanyName = $_POST['C$CompanyName'];
                $Contractors = $_POST['C$Contractors'];
                $PhoneNumber= $_POST['PhoneNumber'];

                //$db>establishConnection();
                $sql = "INSERT INTO contracts (CompanyID, CompanyName, Contractors,PhoneNumber) VALUES ('$CompanyID', '$CompanyName', '$Contractors','$PhoneNumber')";
