...
if(isset($_POST['updatepharmacist']))
{
    ...
    $Position = mysqli_real_escape_string($conn, $_POST['Email']);
    
    

    $query = "UPDATE admin SET SSN='$SSN', Name='$Name', Password='$Password', Email='$Email',PhoneNumber='$PhoneNumber'  WHERE SSN='$SSN' ";
    $query_run = mysqli_query($conn, $query);
}
    if($query_run)
    {
