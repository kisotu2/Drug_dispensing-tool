            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Patient Edit 
                            <a href="admintable.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                    ...
                    <?php
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM admin WHERE SSN='$SSN' ";
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="logicadmin.php" method="POST">
