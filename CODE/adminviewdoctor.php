            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $user)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="updatedoctor.php?id=<?= $user['SSN']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="logicdoctor.php" method="POST" class="d-inline">
                        ...
                        <td><a href="insertdoctor.php"  class="btn btn-success btn-sm">Add</a></td>
